...
for trial = 1
    ...
    for subset = 1:6
        ...
        scores_lr(trial,subset) = sum(score);
    end
end
...
for trial = 1:5
    ...
    for subset = 1:6
        ...
        scores_nb(trial, subset) = sum(score == 0);
    end
end

results_lr = mean(scores_lr, 1)/size(test_data, 1)
results_nb = mean(scores_nb, 1)/size(test_data, 1)
figure 
plot(subsets, results_lr, subsets, results_nb)